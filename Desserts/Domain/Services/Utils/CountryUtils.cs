...
using System.Text;
using PhoneNumbers;
namespace Desserts.Services.Domain.Utils
{
    public static class CountryUtils
    {
        ...
        public static CountryModel GetCountryModelByName(string countryName)
        {
            ...
            //var isoCountries = phoneNumberUtil.GetSupportedRegions();
            ...
            return regionInfo != null
                ? new CountryModel
                {
                    ...
                    PhoneNoFormat = phoneNumberUtil.Format(phoneNumberUtil.GetExampleNumberForType(regionInfo.TwoLetterISORegionName, PhoneNumberType.MOBILE), PhoneNumberFormat.INTERNATIONAL)                    //FlagUrl = $"https://hatscripts.github.io/circle-flags/flags/{regionInfo.TwoLetterISORegionName.ToLower()}.svg",
                }
                : new CountryModel
                {
